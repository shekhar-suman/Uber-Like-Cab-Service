...
if (!$con)
	...
	if (mysqli_num_rows($result) > 0)
		...
		if ($result)
			...
			<a href=http://cabs.shekhar-mbp.rakofilabs.com/verify.php?token=' . $verification_code . '>http://cabs.shekhar-mbp.rakofilabs.com/verify.php?token=' . $verification_code . '</a>
